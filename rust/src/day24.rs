...
async fn day24_async(input: &str, ctx: &mut AOContext) {
        ...
        entries: &[
            ...
            wgpu::BindGroupLayoutEntry {
                ...
                ty: wgpu::BindingType::Buffer {
                    ...
                    has_dynamic_offset: false,
                    min_binding_size: NonZeroU64::new((stones.len() * size_of::<Vertex>()) as u64),
                },
                count: None,
            }
        ]
    ...
    let result_bind_group_layout = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor { 
        ...
        entries: &[
            wgpu::BindGroupLayoutEntry {
                ...
                ty: wgpu::BindingType::Buffer {
                    ...
                    has_dynamic_offset: false,
                    min_binding_size: NonZeroU64::new((stones.len() * stones.len() * size_of::<u32>()) as u64),
                },
                count: None,
            }
        ]
    ...
    encoder.copy_buffer_to_buffer(&result_buffer, 0, &output_buffer, 0, (size_of::<u32>() * stones.len() * stones.len()) as u64);
